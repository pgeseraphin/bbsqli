<div id="sidebar">
	<ul class="sideNav">
    	...
    	<li><a href="test_limit.php" <?php if($active==5) echo " class=active"; ?>>LIMIT</a></li>
    	<li><a href="test_limit_quote_intval.php" <?php if($active==6) echo " class=active"; ?>>LIMIT + Guillemet + intval</a></li>
    	<li><a href="test_limit_is_numeric.php" <?php if($active==7) echo " class=active"; ?>>LIMIT + is_numeric</a></li>                    	
    </ul>
    <!-- // .sideNav -->
</div>    
<!-- // #sidebar -->