...
?>
        ...
        <div id="containerHolder">
			<div id="container">
			     <div id="sidebar">  
        		    <ul class="sideNav"> 
        		     <li><a title = "Test sans affichage d'erreur" href="test_post1.php">POST (sans erreur)</a></li>
        		     <li><a title = "Test avec affichage d'erreur" href="post/test_post2.php">POST (avec erreur)</a></li>         		     
        		    </ul>              	
                    <!-- // .sideNav -->
                </div>  
                <!-- // #sidebar -->
